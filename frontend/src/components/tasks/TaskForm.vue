...
const loadChats = async (n: string, forceRefresh: boolean = false) => { const t=localStorage.getItem('tg-signer-token')||''; try{availableChats.value=await getAccountChats(t,n,forceRefresh)}catch(e){console.error(e)} }
